$(function() {
	...
	$('#ltr').click(function(){
		$("body.topnav-collapsed").removeClass('rtl').addClass('ltr');
		$(this).css("display","none");
		$('#rtl').css("display", "block");
		$('.acc-menu li a').removeClass('rtl');
	});
	$('.static-leftbar-wrapper.leftbar-custom').removeClass('leftbar-bunting');
	...
	//------------------------
        ...
        $("#leftbarline1").sparkline([2,6,7,1,0,3,5], {
            ...
            lineWidth: 2,
            lineColor: '#9ccc65',
            fillColor: 'rgba(156, 204, 101, 0.2)',
            minSpotColor: false,
		    maxSpotColor: false,
		    spotColor: false,
		    spotRadius: 0,
