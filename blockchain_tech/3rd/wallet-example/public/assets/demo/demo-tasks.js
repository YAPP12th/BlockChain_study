...
$( function () {
	...
	$('.card-task .checkbox').click( function () {
		var total = $(this).closest('.card-task').find('.checkbox input').length;
		var checked = $(this).closest('.card-task').find('.checkbox input:checked').length;
	...
	$('.card-task').each( function () {
		var total = $(this).find('.checkbox input').length;
		var checked = $(this).find('.checkbox input:checked').length;
